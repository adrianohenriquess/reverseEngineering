...
public class FlywaySchemaHistory  implements java.io.Serializable {
    ...
    public FlywaySchemaHistory(int installedRank, String description, String type, String script, Integer checksum, String installedBy, Date installedOn, int executionTime, boolean success) {
       this.installedRank = installedRank;
       this.description = description;
       this.type = type;
       this.script = script;
